...
katex.render("\\Delta_t p_n = \\frac{1}{2} p_{n+1}\n    - 2 \\cdot \\frac{1}{2} p_{n}\n    + \\frac{1}{2} p_{n-1}", eq1, {"displayMode":true,"leqno":false,"fleqn":false,"throwOnError":true,"errorColor":"#cc0000","strict":"warn","output":"htmlAndMathml","trust":false,"macros":{"\\f":"#1f(#2)"}})
katex.render("\\Delta_t p_n = \\frac{1}{2} [ (p_{n+1} - p_{n})-(p_{n}-p_{n-1})]", eq2, {"displayMode":true,"leqno":false,"fleqn":false,"throwOnError":true,"errorColor":"#cc0000","strict":"warn","output":"htmlAndMathml","trust":false,"macros":{"\\f":"#1f(#2)"}})
katex.render("\\Delta_t p_n = \\frac{1}{2} \\Delta_x (\\Delta_x p_n)", eq3, {"displayMode":true,"leqno":false,"fleqn":false,"throwOnError":true,"errorColor":"#cc0000","strict":"warn","output":"htmlAndMathml","trust":false,"macros":{"\\f":"#1f(#2)"}})

katex.render("\\frac{\\Delta_t p_n}{\\Delta t} = \\frac{1}{2} \\frac{\\Delta_x p_n (\\Delta_x p_n)}{(\\Delta x)^2} \\cdot \\frac{(\\Delta x)^2}{\\Delta t}", eq6, {"displayMode":true,"leqno":false,"fleqn":false,"throwOnError":true,"errorColor":"#cc0000","strict":"warn","output":"htmlAndMathml","trust":false,"macros":{"\\f":"#1f(#2)"}})
katex.render("\\frac{\\Delta_t p_n}{\\Delta t} = D \\cdot \\frac{\\Delta_x p_n (\\Delta_x p_n)}{(\\Delta x)^2} ", eq7, {"displayMode":true,"leqno":false,"fleqn":false,"throwOnError":true,"errorColor":"#cc0000","strict":"warn","output":"htmlAndMathml","trust":false,"macros":{"\\f":"#1f(#2)"}})
...
katex.render("\\frac{\\partial p_n}{\\partial t} = D \\cdot \\frac{\\partial^2 p_n}{\\partial x^2} ", eq8, {"displayMode":true,"leqno":false,"fleqn":false,"throwOnError":true,"errorColor":"#cc0000","strict":"warn","output":"htmlAndMathml","trust":false,"macros":{"\\f":"#1f(#2)"}})
